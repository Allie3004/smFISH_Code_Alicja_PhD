...
for worm in worms:
    ...
    """
    for cell in cells:
        if (l2_cells[str(cell)][0] and l2_cells[str(cell)][2]) in set['ROI_attribute'].unique():
            ...
            print('d')
        elif (l2_cells[str(cell)][0] and l2_cells[str(cell)][3]) in set['ROI_attribute'].unique():
            print('a')
        ...
        elif (l2_cells[str(cell)][1] and l2_cells[str(cell)][2]) in set['ROI_attribute'].unique():
            print('b')
        ...
        elif l2_cells[str(cell)][1] and l2_cells[str(cell)][3] in set['ROI_attribute'].unique():
            print('c')
            #set['ROI_attribute'] = set['ROI_attribute'].replace({l2_cells[str(cell)][1]:str(cell)+'a',l2_cells[str(cell)][3]:str(cell)+'p'})
        elif l2_cells[str(cell)][0] in set['ROI_attribute']:
            print('e')
    """
